...
*
******************************************************************************/
package com.bridgelabz.fundoolabelmodule.config;
...
public class Config {
	 ...
	 */
	@Bean
	public RedisTemplate<String, Label> redisTemplate() {
		final RedisTemplate<String, Label> template = new RedisTemplate<>();
		template.setConnectionFactory(jedisConnectionFactory());
		template.setValueSerializer(new GenericToStringSerializer<>(Label.class));
